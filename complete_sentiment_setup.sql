-- =====================================================
-- COMPLETE SENTIMENT PREVIEW SETUP
-- Date: 2025-11-20
-- Description: All-in-one migration to enable sentiment preview
--              Creates table, adds missing columns, fixes RLS, adds sample data
-- =====================================================
...
-- Step 2: Create tvk_sentiment_reports table
-- =====================================================
CREATE TABLE IF NOT EXISTS tvk_sentiment_reports (
  ...
  top_issue VARCHAR(100), -- ⭐ ADDED: Top issue for preview display
...
-- Step 5: Drop old problematic RLS policies (if they exist)
-- =====================================================
...
-- Step 6: Create new auth-based RLS policies
-- =====================================================
-- SELECT policy
...
-- Step 7: Insert 10 sample sentiment reports
-- =====================================================
...
BEGIN
  ...
  SELECT EXISTS (
    ...
    WHERE table_name = 'tvk_sentiment_reports'
  ) INTO table_exists;

  -- Count rows
  IF table_exists THEN
    SELECT COUNT(*) INTO row_count FROM tvk_sentiment_reports;
    RAISE NOTICE '✅ Table "tvk_sentiment_reports" exists';
    RAISE NOTICE '✅ Total sentiment reports in database: %', row_count;
    RAISE NOTICE '✅ Migration completed successfully!';
  ELSE
    RAISE NOTICE '❌ Table "tvk_sentiment_reports" does not exist';
  END IF;
END $$;
